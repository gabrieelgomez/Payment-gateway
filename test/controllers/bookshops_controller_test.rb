...
class BookshopsControllerTest < ActionController::TestCase
  ...
  test "should create bookshop" do
    assert_difference('Bookshop.count') do
      post :create, bookshop: { address: @bookshop.address, attendat: @bookshop.attendat, email: @bookshop.email, name: @bookshop.name, phone: @bookshop.phone, place: @bookshop.place }
    end
  ...
  test "should update bookshop" do
    patch :update, id: @bookshop, bookshop: { address: @bookshop.address, attendat: @bookshop.attendat, email: @bookshop.email, name: @bookshop.name, phone: @bookshop.phone, place: @bookshop.place }
    assert_redirected_to bookshop_path(assigns(:bookshop))
  end
